...
const {
  PORT = 8080,
  NODE_ENV = 'production',
  STABILITY_API_KEY, // optional for future AI provider

  // ----- STRIPE -----
  STRIPE_SECRET_KEY,
  STRIPE_PRICE_STARTER,            // e.g. price_123...
  STRIPE_PRICE_CREATOR_MONTHLY,    // e.g. price_456...
  STRIPE_PRICE_PRO_STUDIO,         // e.g. price_789...
